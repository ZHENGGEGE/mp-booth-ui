      ...
      <View className="cuntainer">
            ...
            list.array.map(item => {
              return (
                <View className="at-col colBody" key={item[0]}>
                  ...
                  >
                    <View className="title_header">{item.title}</View>
                    <View className="title_descripe">
                      {item.source.length > 16
                        ? item.source.substring(0, 16) + "..."
                        : item.source}
                    </View>
                  </View>
                </View>
        ...
        <AtTabBar
          ...
          tabList={[
            {
              title: "政策查询",
              image: current === 1 ? policyUnFocus : policyFocus
            },
            {
              title: "摆摊技巧",
              image: current === 0 ? searchUnfocus : searchfocus
            }
          ]}
