...
export default [
  ...
  {
    iconPath: imgUrl,
    id: 4, // 标记点 id marker 点击事件回调会返回此 id。建议为每个 marker 设置上 number 类型 id，保证更新 marker 时有更好的性能。
    name: "常发广场",
